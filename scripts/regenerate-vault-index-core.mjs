/**
 * Helpers for rebuilding the wiki index and MOC files.
 *
 * The CLI wrapper stays side-effectful, while the file collection and markdown
 * generation logic remains directly testable here.
 */
...
export async function collectPages(dir) {
...
export function buildIndex(concepts, queries) {
...
export function buildMoc(concepts) {
